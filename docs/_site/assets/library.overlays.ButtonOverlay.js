skit.define("library.overlays.ButtonOverlay:js", ["skit.browser.ElementWrapper:js","skit.browser.events:js","skit.platform.iter:js","skit.platform.string:js","skit.platform.util:js","library.overlays.Overlay:js"], function() {  return ((function(skit_browser_ElementWrapper,skit_browser_events,skit_platform_iter,skit_platform_string,skit_platform_util,library_overlays_Overlay) { var module = {exports: {}}; var defined = null; function define() {   for (var i = 0; i < arguments.length; i++) {     if (typeof arguments[i] == 'function') { defined = arguments[i](); break; }   } } define.amd = true; var result = (function library_overlays_ButtonOverlay_js() {'use strict';
/**
 * @license
