skit.define("library.misc.inlineeditable:js", ["skit.platform.PubSub:js","skit.platform.iter:js","skit.platform.util:js","skit.browser.ElementWrapper:js","skit.browser.events:js","skit.browser.layout:js"], function() {  return ((function(skit_platform_PubSub,skit_platform_iter,skit_platform_util,skit_browser_ElementWrapper,skit_browser_events,skit_browser_layout) { var module = {exports: {}}; var defined = null; function define() {   for (var i = 0; i < arguments.length; i++) {     if (typeof arguments[i] == 'function') { defined = arguments[i](); break; }   } } define.amd = true; var result = (function library_misc_inlineeditable_js() {/**
 * @license
