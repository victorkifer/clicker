skit.define("library.tasks.AsyncTask:js", [], function() {  return ((function() { var module = {exports: {}}; var defined = null; function define() {   for (var i = 0; i < arguments.length; i++) {     if (typeof arguments[i] == 'function') { defined = arguments[i](); break; }   } } define.amd = true; var result = (function library_tasks_AsyncTask_js() {/**
 * @license
...
return AsyncTask;})(); return result || defined || module.exports; })).apply(this, arguments)});