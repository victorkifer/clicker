skit.define("library.uploads.GAEUploadTask:js", ["skit.platform.env:js","skit.platform.iter:js","skit.platform.json:js","skit.platform.urls:js","skit.platform.util:js","library.tasks.AsyncTask:js"], function() {  return ((function(skit_platform_env,skit_platform_iter,skit_platform_json,skit_platform_urls,skit_platform_util,library_tasks_AsyncTask) { var module = {exports: {}}; var defined = null; function define() {   for (var i = 0; i < arguments.length; i++) {     if (typeof arguments[i] == 'function') { defined = arguments[i](); break; }   } } define.amd = true; var result = (function library_uploads_GAEUploadTask_js() {/**
 * @license
...
var AsyncTask = library_tasks_AsyncTask;
...
return GAEUploadTask;})(); return result || defined || module.exports; })).apply(this, arguments)});