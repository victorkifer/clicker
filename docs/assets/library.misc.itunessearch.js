skit.define("library.misc.itunessearch:js", ["skit.browser.dom:js","skit.platform.iter:js","skit.platform.urls:js"], function() {  return ((function(skit_browser_dom,skit_platform_iter,skit_platform_urls) { var module = {exports: {}}; var defined = null; function define() {   for (var i = 0; i < arguments.length; i++) {     if (typeof arguments[i] == 'function') { defined = arguments[i](); break; }   } } define.amd = true; var result = (function library_misc_itunessearch_js() {/**
 * @license
