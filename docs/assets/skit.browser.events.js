skit.define("skit.browser.events:js", ["skit.browser.Event:js","skit.platform.iter:js","skit.browser.ElementWrapper:js"], function() {  return ((function(skit_browser_Event,skit_platform_iter,skit_browser_ElementWrapper) { var module = {exports: {}}; var defined = null; function define() {   for (var i = 0; i < arguments.length; i++) {     if (typeof arguments[i] == 'function') { defined = arguments[i](); break; }   } } define.amd = true; var result = (function skit_browser_events_js() {'use strict';
'browser-only';
